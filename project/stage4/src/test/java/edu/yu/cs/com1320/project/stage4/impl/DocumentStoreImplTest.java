...
public class DocumentStoreImplTest {
    ...
    private URI gabeAlternateURI;
    private String gabeAlternateTxt;
    ...
    public void init() throws Exception {
        ...
        this.gabeAlternateURI = new URI("http://edu.yu.cs/com1320/project/doc5");
        this.gabeAlternateTxt = "This is my alt";
    }
    ...
    @Test
    public void settingMaxDocTo3Before() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(3);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt4.getBytes()),this.uri4, DocumentStore.DocumentFormat.TXT);
        //the Doc corresponding to URI1 should not be there anymore
        assertNull(firstStore.getDocument(this.uri1)); //Last Used
    }
    @Test
    public void settingMaxDocTo3BeforeAndChangingTheDoc() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(3);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.gabeAlternateTxt.getBytes()), this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt4.getBytes()),this.uri4, DocumentStore.DocumentFormat.TXT);
        //the Doc corresponding to URI2 should not be there anymore, bc uri1's doc was changed
        assertNull(firstStore.getDocument(this.uri2)); //Last Used
    }

    @Test
    public void settingMaxDocTo3After() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
    ...
    @Test
    public void settingMaxDocTo4Before() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(4);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt4.getBytes()),this.uri4, DocumentStore.DocumentFormat.TXT);
        assertNotNull(firstStore.getDocument(this.uri1));//should still be there
    }

    @Test
    public void settingMaxDocTo1After() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        ...
        firstStore.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt4.getBytes()),this.uri4, DocumentStore.DocumentFormat.TXT);
        firstStore.setMaxDocumentCount(1);

        assertNull(firstStore.getDocument(this.uri1));
        assertNull(firstStore.getDocument(this.uri2));
        assertNull(firstStore.getDocument(this.uri3));
    }
    @Test
    public void settingMaxDocTo1Before() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(1);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
    ...
    @Test
    public void settingMaxDocTo3AndThenUndoing() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(3);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        ...
        firstStore.undo();
        assertNull(firstStore.getDocument(this.uri1));
        assertNull(firstStore.getDocument(this.uri4));
    }

    @Test
    public void settingMaxDocTo3AndThenUndoingURI1() throws IOException {
        DocumentStoreImpl firstStore = new DocumentStoreImpl();
        firstStore.setMaxDocumentCount(3);
        firstStore.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt3.getBytes()),this.uri3, DocumentStore.DocumentFormat.TXT);
        firstStore.putDocument(new ByteArrayInputStream(this.txt4.getBytes()),this.uri4, DocumentStore.DocumentFormat.TXT);
        firstStore.undo(uri1);
        assertNull(firstStore.getDocument(this.uri1));
    }

    @Test
    public void searchAndMakeSureTheTwoThatWereNotSearchedArentThere() throws IOException {
        DocumentStoreImpl sampleStore = (DocumentStoreImpl) this.getStoreWithTextAdded();
        List<Document> results = this.search(sampleStore,"plain",2);
        sampleStore.setMaxDocumentCount(2); //Only two docs left in the store should be these two
        ...
        assertNull(sampleStore.getDocument(this.uri3));
        assertNull(sampleStore.getDocument(this.uri4));
